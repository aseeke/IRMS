...
### 5. 🏢 组织架构与办公室管理
- **多级部门体系**：支持无限级树形部门结构。
- **办公室精准定位**：新增办公室管理模块，实现资产物理位置的精确记录。
- **级联自动化**：选择用户后，系统自动关联其所属部门与办公室，减少人工录入误差。
...
| 模块 | 技术栈 | 说明 |
| :--- | :--- | :--- |
| **前端核心** | Vue 3 + TypeScript | 组合式 API，类型安全 |
| **前端 UI** | Naive UI + TailwindCSS | 极简美学，响应式布局 |
| **后端核心** | Spring Boot 3.2+ | 现代 Java 开发标准 |
